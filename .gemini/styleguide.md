# Sika Security Python Style Guide

# Introduction
This style guide outlines the coding conventions for Python code developed at Sika Security.
...
## Logging
* **Use a standard logging framework:**  Sika Security uses the built-in `logging` module.
