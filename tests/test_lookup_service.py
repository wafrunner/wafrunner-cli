...
class TestLookupService(unittest.TestCase):
    ...
    def test_lookup_ids_with_cve(self, mock_get_vuln_id):
        ...
        self.assertEqual(result, {'cve_id': 'CVE-2024-1111', 'vuln_id': 'vuln-from-cve'})
    ...
    def test_lookup_ids_with_vuln_id(self, mock_get_cve_id):
        ...
        self.assertEqual(result, {'cve_id': 'cve-from-vuln', 'vuln_id': 'a1ddadd4-1b9d-4fab-90fe-64c1c763cd58'})
