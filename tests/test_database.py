...
class TestDatabase(unittest.TestCase):
    ...
    def test_create_table(self):
        ...
        self.db.cursor.execute("SELECT name FROM sqlite_master WHERE type='table' AND name='cve_lookup'")
        self.assertIsNotNone(self.db.cursor.fetchone())

    def test_insert_and_clear_cve_data(self):
        # Test inserting data
        sample_data = [
            {'cve_id': 'CVE-2024-0001', 'vuln_id': 'vuln-0001', 'last_modified': '2024-01-01'},
            {'cve_id': 'CVE-2024-0002', 'vuln_id': 'vuln-0002', 'last_modified': '2024-01-02'}
        ]
